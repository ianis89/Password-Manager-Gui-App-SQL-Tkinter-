...
root = Tk()
root.title("Welcome to the Password Manager :)")

root.geometry("500x400")
root.minsize(600, 400)
root.maxsize(600, 400)
root.configure(bg='#9B5FC0')

frame = Frame(root, bg="#30D5C8", bd=5)
...
root.option_add("*Font", "Roboto 10 bold")

app_name_label = Label(root, text="Application Name:", fg='#000000')
app_name_label.grid(row=0, column=0)
url_label = Label(root, text="URL:", fg='#000000')
url_label.grid(row=1, column=0)
email_id_label = Label(root, text="Email Id:", fg='#000000')
email_id_label.grid(row=2, column=0)
password_label = Label(root, text="Password:", fg='#000000')
password_label.grid(row=3, column=0)
# delete_label = Label(root, text = "Delete Record#:")
# delete_label.grid(row=6, column=1)

# Create Submit Button
submit_btn = Button(root, text="Add Record", command=submit, bg="#FFC300", fg="white")
submit_btn.grid(row=5, column=0, pady=5, padx=15, ipadx=35)
submit_btn.configure(font=("Arial", 10, "bold"))


# Create a Query Button
query_btn = Button(root, text="Show Records", command=query, bg="#FFC300", fg="white")
query_btn.grid(row=5, column=1, pady=5, padx=5, ipadx=35)
query_btn.configure(font=("Arial", 10, "bold"))


# Create a Delete Button
delete_btn = Button(root, text="Delete Record", command=delete, bg="#FF5733", fg="white")
delete_btn.grid(row=6, column=0, ipadx=30)
delete_btn.configure(font=("Arial", 10, "bold"))


# Create a Update Button
update_btn = Button(root, text="Update Record", command=update, bg="#C70039", fg="white")
update_btn.grid(row=7, column=0, ipadx=30)
update_btn.configure(font=("Ar# root.destroy()ial", 10, "bold"))
